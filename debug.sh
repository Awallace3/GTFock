#!/usr/bin/bash
# mpigdb -np 8 -- ./build/pscf/pscf  data/cc-pvdz/cc-pvdz.gbs data/alkane/alkane_62.xyz 4 2 2 5 10
...
mpigdb -np 2 -- ./build/pscf/pscf data/cc-pvdz/cc-pvdz.gbs data/alkane/alkane_62.xyz 2 1 1 5 10
