...
# WATER EXAMPLE
# mpirun --mca btl ^openib -np 8 build/pscf/pscf ./data/aug-cc-pvtz.gbs ./data/water.xyz 4 2 2 5 10
mpirun --mca btl ^openib -np 2 build/pscf/pscf ./data/aug-cc-pvtz.gbs ./data/water.xyz 2 1 1 5 10
